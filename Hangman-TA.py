...
#credits
print("made by Total Aviation and JayVFD ")
print("Beta ")
...
print("https://github.com/TotalAviationJmyt for Total Aviation version or https://github.com/JayVFD for JayVFD version")
print("Beta")        
